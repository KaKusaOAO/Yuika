...
internal static class OpenGLFormats
{
    ...
    internal static PixelInternalFormat VdToGLPixelInternalFormat(PixelFormat format)
    {
        switch (format)
        {
            ...
            case PixelFormat.ETC2_R8_G8_B8_UNorm:
                return (PixelInternalFormat) 0x9274; // PixelInternalFormat.CompressedRgb8Etc2;
            case PixelFormat.ETC2_R8_G8_B8_A1_UNorm:
                return (PixelInternalFormat) 0x9276; // PixelInternalFormat.CompressedRgb8PunchthroughAlpha1Etc2;
            case PixelFormat.ETC2_R8_G8_B8_A8_UNorm:
                return (PixelInternalFormat) 0x9278; // PixelInternalFormat.CompressedRgba8Etc2Eac;
    ...
    internal static SizedInternalFormat VdToGLSizedInternalFormat(PixelFormat format, bool depthFormat)
    {
        switch (format)
        {
            ...
            case PixelFormat.ETC2_R8_G8_B8_UNorm:
                return (SizedInternalFormat) 0x9274; // PixelInternalFormat.CompressedRgb8Etc2;
            case PixelFormat.ETC2_R8_G8_B8_A1_UNorm:
                return (SizedInternalFormat) 0x9276; // PixelInternalFormat.CompressedRgb8PunchthroughAlpha1Etc2;
            case PixelFormat.ETC2_R8_G8_B8_A8_UNorm:
                return (SizedInternalFormat) 0x9278; // PixelInternalFormat.CompressedRgba8Etc2Eac;
